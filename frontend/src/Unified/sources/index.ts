...
// 用户选择文件数据源
export { UserSelectedFileSource, isUserSelectedSource } from './UserSelectedFileSource.ts'

// 远程文件数据源
export { RemoteFileSource, isRemoteSource } from './RemoteFileSource.ts'
 ...
 */
export type UnifiedDataSource = UserSelectedFileSource | RemoteFileSource
